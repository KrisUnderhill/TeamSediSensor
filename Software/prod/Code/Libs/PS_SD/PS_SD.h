// PS_SD.h copy of the SD.h arduino library (see below)
// with one change: call to spi.begin() in SDFS.begin()
// has been modified to use the SPI pins as defined below
// 
// Kris Miedema 04/06/22
